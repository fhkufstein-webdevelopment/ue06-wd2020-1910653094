...
define('DB_NAME', 'ue06-wd2020-1910653094');
...
if ($db->numRows($result)>0) {
    //kein while nötig –wir wissen es gibt nur einen Wert.
    // Mehre Zeilen könnte man mit while($row = $db->fetchAssoc($result)) herausholen
    ...
    if(password_verify("testpassword", $row['password'])){
        echo "Der Nutzer ".$username." mit der ID ".$row['id']." hat";echo " das Passwort testpassword";
    } else {
